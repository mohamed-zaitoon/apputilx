package com.mohamedzaitoon.apputilx.app
...
object Notification {
    ...
    fun deleteChannel(channelId: String, context: Context = AppUtilX.ctx()) {
        val manager = context.getSystemService(Context.NOTIFICATION_SERVICE)
            as? NotificationManager
            ?: return
    ...
    fun cancel(notificationId: Int, context: Context = AppUtilX.ctx()) {
        NotificationManagerCompat.from(context).cancel(notificationId)
    }

    fun cancelAll(context: Context = AppUtilX.ctx()) {
        NotificationManagerCompat.from(context).cancelAll()
    }

    fun canPostNotifications(context: Context = AppUtilX.ctx()): Boolean = hasPermission(context)
